                        ...
                        if (subjectSnapshot.exists()) {
                            ...
                            if (subjectData.MED209) {
                                ...
                                if ((date.getDay() == 1 || date.getDay() == 3) && ((date.getHours() == 21) || (date.getHours() == 22 && date.getMinutes() == 0))) {
                                    initButton("#med209AtteMark", subjectData.MED209.TimeStamp, '/users/' + data.user.uid + '/classes/MED209', subjectClass.MED209.ClassHeld + 1);
                                    $("#med209AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/MED209', subjectData.MED209.Attendance + 1, "#med209AtteMark", subjectClass.MED209.ClassHeld);
                            ...
                            if (subjectData.CSD101) {
                                ...
                                if ((date.getDay() == 1 || date.getDay() == 3) && ((date.getHours() == 21) || (date.getHours() == 22 && date.getMinutes() == 0))) {
                                    initButton("#csd101AtteMark", subjectData.CSD101.TimeStamp, '/users/' + data.user.uid + '/classes/CSD101', subjectClass.CSD101.ClassHeld + 1);
                                    $("#csd101AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/CSD101', subjectData.CSD101.Attendance + 1, "#csd101AtteMark", subjectClass.CSD101.ClassHeld);
                            ...
                            if (subjectData.EED102) {
                                ...
                                if ((date.getDay() == 1 || date.getDay() == 3) && ((date.getHours() == 22) || (date.getHours() == 23 && date.getMinutes() == 0))) {
                                    initButton("#eed102AtteMark", subjectData.EED102.TimeStamp, '/users/' + data.user.uid + '/classes/EED102', subjectClass.EED102.ClassHeld + 1);
                                    $("#eed102AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/EED102', subjectData.EED102.Attendance + 1, "#eed102AtteMark", subjectClass.EED102.ClassHeld);
                            ...
                            if (subjectData.CSD201) {
                                ...
                                if ((date.getDay() == 2 || date.getDay() == 4) && ((date.getHours() == 22) || (date.getHours() == 23 && date.getMinutes() == 0))) {
                                    ...
                                    $("#csd201AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/CSD201', subjectData.CSD201.Attendance + 1, "#csd201AtteMark", subjectClass.CSD201.ClassHeld);
                            ...
                            if (subjectData.EED208) {
                                ...
                                if ((date.getDay() == 3 || date.getDay() == 5) && ((date.getHours() == 22) || (date.getHours() == 23 && date.getMinutes() == 0))) {
                                    initButton("#eed208AtteMark", subjectData.EED208.TimeStamp, '/users/' + data.user.uid + '/classes/EED208', subjectClass.EED208.ClassHeld + 1);
                                    $("#eed208AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/EED208', subjectData.EED208.Attendance + 1, "#eed208AtteMark", subjectClass.EED208.ClassHeld);
                            ...
                            if (subjectData.EED204) {
                                ...
                                if ((date.getDay() == 3 || date.getDay() == 5) && ((date.getHours() == 20) || (date.getHours() == 21 && date.getMinutes() == 0))) {
                                    initButton("#eed204AtteMark", subjectData.EED204.TimeStamp, '/users/' + data.user.uid + '/classes/EED204', subjectClass.EED204.ClassHeld + 1);
                                    $("#eed204AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/EED204', subjectData.EED204.Attendance + 1, "#eed204AtteMark", subjectClass.EEd204.ClassHeld);
                            ...
                            if (subjectData.MAT104) {
                                ...
                                if ((date.getDay() == 2 || date.getDay() == 4) && ((date.getHours() == 21) || (date.getHours() == 22 && date.getMinutes() == 0))) {
                                    initButton("#mat104AtteMark", subjectData.MAT104.TimeStamp, '/users/' + data.user.uid + '/classes/MAT104', subjectClass.MAT104.ClassHeld + 1);
                                    $("#mat104AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/MAT104', subjectData.MAT104.Attendance + 1, "#mat104AtteMark", subjectClass.MAT104.ClassHeld);
                            ...
                            if (subjectData.PHY102) {
                                ...
                                if ((date.getDay() == 2 || date.getDay() == 4) && ((date.getHours() == 20) || (date.getHours() == 21 && date.getMinutes() == 0))) {
                                    initButton("#phy102AtteMark", subjectData.PHY102.TimeStamp, '/users/' + data.user.uid + '/classes/PHY102', subjectClass.PHY102.ClassHeld + 1);
                                    $("#phy102AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/PHY102', subjectData.PHY102.Attendance + 1, "#phy102AtteMark", subjectClass.PHY102.ClassHeld);
                            ...
                            if (subjectData.CSD204) {
                                ...
                                if ((date.getDay() == 2 || date.getDay() == 5) && ((date.getHours() == 21) || (date.getHours() == 22 && date.getMinutes() == 0))) {
                                    initButton("#csd204AtteMark", subjectData.CSD204.TimeStamp, '/users/' + data.user.uid + '/classes/CSD204', subjectClass.CSD204.ClassHeld + 1);
                                    $("#csd204AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/CSD204', subjectData.CSD204.Attendance + 1, "#csd204AtteMark", subjectClass.CSD204.ClassHeld);
                            ...
                            if (subjectData.EED205) {
                                ...
                                if ((date.getDay() == 1 || date.getDay() == 4) && ((date.getHours() == 20) || (date.getHours() == 21 && date.getMinutes() == 0))) {
                                    initButton("#eed205AtteMark", subjectData.EED205.TimeStamp, '/users/' + data.user.uid + '/classes/EED205', subjectClass.EED205.ClassHeld + 1);
                                    $("#eed205AtteMark").on('click', function() {
                                        markAttendance('/users/' + data.user.uid + '/classes/EED205', subjectData.EED205.Attendance + 1, "#eed205AtteMark", subjectClass.EED205.ClassHeld);
