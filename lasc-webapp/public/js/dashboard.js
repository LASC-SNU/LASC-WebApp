        ...
        if(snapshot.exists()){
          ...
          if(subjectData.CED101){
            ...
            $("#ced101AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/CED101',subjectData.CED101.Attendance + 1);
            });
          }
          if(subjectData.MED209){
            ...
            $("#med209AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/MED209',subjectData.MED209.Attendance + 1);
            });
          }
          if(subjectData.CSD101){
            ...
            $("#csd101AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/CSD101',subjectData.CSD101.Attendance + 1);
            });
          }
          if(subjectData.EED102){
            ...
            $("#eed102AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/EED102',subjectData.EED102.Attendance + 1);
            });
          }
          if(subjectData.CSD201){
            ...
            $("#csd201AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/CSD201',subjectData.CSD201.Attendance + 1);
            });
          }
          if(subjectData.EED208){
            ...
            $("#eed208AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/EED208',subjectData.EED208.Attendance + 1);
            });
          }
          if(subjectData.EED204){
            ...
            $("#eed204AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/EED204',subjectData.EED204.Attendance + 1);
            });
          }
          if(subjectData.MAT104){
            ...
            $("#mat104AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/MAT104',subjectData.MAT104.Attendance + 1);
            });
          }
          if(subjectData.PHY102){
            ...
            $("#phy102AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/PHY102',subjectData.PHY102.Attendance + 1);
            });
          }
          if(subjectData.CSD204){
            ...
            $("#csd204AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/CSD204',subjectData.CSD204.Attendance + 1);
            });
          }
          if(subjectData.EED205){
            ...
            $("#eed205AtteMark").on('click',function(){
              markAttendance('/users/' + data.user.uid + '/classes/EED205',subjectData.EED205.Attendance + 1);
            });
          }
        }
      });
...
function markAttendance(classURL,attendanceValue){
